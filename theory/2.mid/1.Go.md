...
***Run time:***
Puede ser el timpo de ejecucion de un programa, o el entorno en donde se ejecuta como tu pc, Tambien puede referirce a todas las cosas necesarias para que tu programa pero no son Bibliotecas como fmt,io o hhtp si no mas bien serian como 
